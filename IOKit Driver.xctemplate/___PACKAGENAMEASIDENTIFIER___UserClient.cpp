...
#include "___PACKAGENAME___UserClient.h"
...
OSDefineMetaClassAndFinalStructors(___PACKAGENAME___UserClient, IOUserClient)

bool ___PACKAGENAME___UserClient::initWithTask(task_t owningTask, void *securityID, uint32_t type) {
...
IOReturn ___PACKAGENAME___UserClient::externalMethod(uint32_t selector, IOExternalMethodArguments *args, IOExternalMethodDispatch *dispatch, OSObject *target, void *reference) {
    static const IOExternalMethodDispatch methods[] =
    {
        /* 0 */ { (IOExternalMethodAction)&___PACKAGENAME___UserClient::kread,  3, 0, 0, 0 },
    };
...
IOReturn ___PACKAGENAME___UserClient::kread(___PACKAGENAME___UserClient *client, void *reference, IOExternalMethodArguments *args)
{
